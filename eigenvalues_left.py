...
if __name__ == "__main__":
    ...
    plot_label = r'$f(\Upsilon)=f_{\text{left}}(\Upsilon)$, $\Upsilon_1<\Upsilon<b_{22}$' + rf', $L={L}$'
    plot_filename = 'eigenvalues_plot-left.png'
    horizon_for_Upsilon = 1e-7
    Upsilon_min = Upsilon_1 + horizon_for_Upsilon
    Upsilon_max = b22
    # Upsilon_min = (0.1)*Upsilon_1
    # Upsilon_max = 0
    N_points = 100
    #
